...
class RepositoryImpl : IRepository {
    ...
    override fun getDataFromLocalStorage(configToRequest: ConfigToRequest): String =
        when (configToRequest.method) {
            ...
            "GetNotificationAll" -> {
                "{\"Items\":[{\"id\":\"siz\",\"title\":\"Необходима замена СИЗ\",\"notifications\":[{\"worker_id\":17,\"worker_full_name\":\"Прунька Иван Иванович\",\"worker_staff_number\":\"15-таб\",\"worker_position_title\":\"Главный инженер\",\"checkup_date_start\":\"2021-07-14\",\"checkup_date_end\":\"2021-07-21\",\"flag\":\"true\",\"status_id\":1},{\"worker_id\":18,\"worker_full_name\":\"Сизов Иван Иванович\",\"worker_staff_number\":\"16-таб\",\"worker_position_title\":\"Главный механик\",\"checkup_date_start\":\"2021-07-13\",\"checkup_date_end\":\"2021-07-20\",\"flag\":\"false\",\"status_id\":19}]},{\"id\":\"medicalExam\",\"title\":\"Запланированный медицинский осмотр\",\"notifications\":[{\"worker_id\":15,\"worker_full_name\":\"Пупкин Иван Иванович\",\"worker_staff_number\":\"15-таб\",\"worker_position_title\":\"Главный инженер\",\"checkup_date_start\":\"2021-07-14\",\"checkup_date_end\":\"2021-07-21\",\"flag\":\"true\",\"status_id\":1},{\"worker_id\":16,\"worker_full_name\":\"Иванов Иван Иванович\",\"worker_staff_number\":\"16-таб\",\"worker_position_title\":\"Главный механик\",\"checkup_date_start\":\"2021-07-13\",\"checkup_date_end\":\"2021-07-20\",\"flag\":\"false\",\"status_id\":19}]}],\"errors\":[],\"status\":1,\"warnings\":[]}"
            }
            else -> ""
        }
